...
class DeleteTermEvaluationUseCase(BaseUseCase[Tuple[HTTPAuthorizationCredentials, int], TermEvaluationResource]):
    ...
    @abstractmethod
    def __call__(self, args: Tuple[HTTPAuthorizationCredentials, int]) -> TermEvaluationResource:
